...
const resumeData = {
  ...
  workExperiences: [
    {
      ...
      keyPoints: [
        "Moved existing apps to TypeScript, lead a team of developers in developing new apps in React-Native, Remix.js, Next.js, etc. ensuring clean-code and robust systems.",
        "Established documentation standards for development, testing and releasing apps. Streamlined development processes.",
        "Effectively managed the end-to-end process of apps testing and releasing.",
      ],
    },
    {
      ...
      keyPoints: [
        "Taught DSA, Advanced Algorithms and Compiler Design classes to MTech and MCA. Published 7 research articles and earned a PhD for my work on Intelligent Tutoring Systems.",
      ],
    },
    {
  ...
  education: [
    {
      about:
        "Qualified GATE, UGC NET, JRF, JEST, HTET, 6 Int. Publications, 3 Int. Conferences – good at teaching concepts & researching.",
    },
    {
      heading: "2018 - 2022",
      about:
        "Doctor of Philosophy (PhD) under UGC Junior Research Fellowship - Computer Science and Engineering, CDLU",
    },
    {
      heading: "2014 - 2017",
      about:
        "Masters in Computer Applications (MCA) Kurukshetra University – <b>70.71%</b>",
    },
    {
      heading: "2011 - 2014",
    ...
    },
    {
      heading: "School",
      about:
        "12<sup>th</sup> Science – CBSE (2011) – <b>81.6%</b><br/>10<sup>th</sup> – CBSE (2009) – <b>81.6%</b>",
    },
  ],
  skills: [
    {
      heading: "Front End",
      content:
        "ReactJS, Redux, NextJS, React Native, HTML, CSS, TailwindCSS, Webpack, Material UI, Jekyll.",
    },
    {
      heading: "Back End",
      content:
        "Django, Rest APIs, NextJS (NodeJS), SQL, PostgreSQL, Supabase, Prisma, Heroku, Vercel, Railway.",
    },
    {
      heading: "Programming Languages",
      content:
        "Object Oriented Design, Python, JavaScript (ES6), TypeScript, C, C++, C#, Java, PHP, SQL, JSON, XML.",
    },
    {
      heading: "Tools & Platforms",
      content:
        "Git, Linux, Docker, Unity3D, Android Studio, Adobe Apps, Figma, Content Management Systems, WordPress, Joomla, Bootstrap, Mac Systems.",
    },
  ],
  projects: [
    {
    ...
    },
    {
      ...
      about:
        "My personal website/portfolio project. It is a <b>Next JS</b> project that utilizes TypeScript, <b>Tailwind CSS</b> and static export. It has <b>responsive design</b>. Feel free to use it and make your own portfolio with it.",
    ...
    },
    {
      ...
      tech: "Unity3D, C#",
      about:
        "An <b>open-source Unity3D</b> project for creating any type of Ludo game. Currently setup as a mobile-based 2D Ludo game with <b>working AI</b>. Can be easily extended to a 3D game or a completely different Ludo game if needed.",
    ...
    >
      ...
      <div className="py-6 px-9">
        ...
        <div className="flex flex-col">
          {/* My Name */}
          <div className="text-6xl mt-3 font-serif font-bold text-blue-600">
            {data.name}
          </div>
          {/* Tagline */}
...
function ExperienceItem({ ...props }: WorkInfo) {
  return (
    <div className="my-0">
      <BaseHeading>
        {props.jobTitle}{" "}
        <span className="text-gray-500">@{props.organization}</span>
      </BaseHeading>
...
function BaseText({ children }: ComponentProps<"div">) {
  return (
    <div
      className="tracking-wide text-xs text-gray-800 prose "
