...
export default function Resume() {
  return (
    ...
    <div className="">
      <Navbar title="Apoorva" showResumeButton={false} />
      <div className="px-6 print:p-0 mx-auto w-full md:w-fit">
        <Section>
          <H1>Apoorva Bhaambhu</H1>
          <P className="print:hidden">
            Hi this is Apoorva Bhaambhu, please feel free to download my resume. I will add more to this page later.
            <div className="flex flex-wrap gap-3 mt-2 print:hidden">
              <Button iconDownload outline href={"/resume-apoorva.pdf"} newTab>
